 ...
 * @version //autogentag//
 */
namespace EzSystems\EzPlatformSolrSearchEngine\IntegrationTests;
...
/**
 * Tests case for translation fallback in the SearchService.
 *
 * @group integration
 * @group search
 * @group translation_fallback
 */
class TranslationFallbackTest extends BaseTest
{
    const SETUP_SINGLE = 'single';
    const SETUP_DEDICATED = 'dedicated';
    const SETUP_SHARED = 'shared';
    const SETUP_SHARED_2 = 'shared_2';
    const SETUP_SHARED_3 = 'shared_3';
    ...
    public static function setUpBeforeClass()
    {
        ...
        fwrite(STDERR, "Core setup: {$coresSetup}\n\n");
    }
                ...
                array(
                    array(
                        ...
                        array(
                            ...
                            self::SETUP_SINGLE => 'localhost:8983/solr/core0',
                            self::SETUP_SHARED_2 => 'localhost:8983/solr/core3',
                            self::SETUP_SHARED_3 => 'localhost:8983/solr/core1',
                        ),
                    ),
                    array(
                        2,
                        ...
                        array(
                            ...
                            self::SETUP_SINGLE => 'localhost:8983/solr/core0',
                            self::SETUP_SHARED_2 => 'localhost:8983/solr/core2',
                            self::SETUP_SHARED_3 => 'localhost:8983/solr/core1',
                        ),
                    ),
                    array(
                        ...
                        array(
                            ...
                            self::SETUP_SHARED => 'localhost:8983/solr/core2',
                            self::SETUP_SINGLE => 'localhost:8983/solr/core0',
                            self::SETUP_SHARED_2 => 'localhost:8983/solr/core0',
                            self::SETUP_SHARED_3 => 'localhost:8983/solr/core1',
                        ),
                    ),
                ),
    ...
    protected function getSetupType()
    {
        ...
        switch ($coresSetup) {
            ...
            case self::SETUP_SHARED_2:
                return self::SETUP_SHARED_2;
            case self::SETUP_SHARED_3:
                return self::SETUP_SHARED_3;
        }
